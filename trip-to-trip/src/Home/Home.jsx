    ...
    return (
        <div id='home-body'>
            ...
            <div id='animation_cloud'>
                 <motion.img id='cloud1_img' className='cloud_img_class' animate={{x:[0,200,200,0]}} transition={{type:"tween",duration:6,repeat:5}} src={cloud1} alt="cloud1" />
                 <motion.img id='cloud2_img' className='cloud_img_class' animate={{x:[0,-400,-400,0]}} transition={{type:"tween",duration:6,repeat:5}} src={cloud2} alt="cloud2" />
                 <motion.img id='cloud3_img' className='cloud_img_class' animate={{x:[0,150,150,0]}} transition={{type:"tween",duration:4,repeat:5}} src={cloud3} alt="cloud3" />
            </div>
